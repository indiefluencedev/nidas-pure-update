			...
			<div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
				<header className="mb-8 border-b pb-4">
					...
					<p className="text-gray-500 mt-2">
						Last updated on 17-04-2025 12:51:34
					</p>
				</header>
				...
				<div className="space-y-6 text-gray-700">
					<p>
						...
						("Terms") constitute a binding agreement by and between NIDHI JAIN,
					...
					<div className="my-6">
						...
						<p className="mt-2">
							In case you do not raise a refund claim within the stipulated
							time, this would make you ineligible for a refund.
						</p>
					</div>
				...
				<footer className="mt-10 pt-6 border-t text-sm text-gray-500 text-center">
					<p>© 2025 NIDHI JAIN. All rights reserved.</p>
				</footer>
			</div>
		</div>
	);
